...
class Guild extends Base {
  constructor(client, data) {
    ...
    this.channels = new GuildChannelManager(client, this._client.options.cache.GuildChannelManager);
    this.members = new GuildMemberManager(client, this._client.options.cache.GuildMemberManager);
    this.roles = new RoleManager(client, this._client.options.cache.RoleManager);
