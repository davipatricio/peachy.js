...
/**
 * @see {@link https://discord.com/developers/docs/topics/gateway#gateway-intents | Discord Intents Documentation}
 */

class Intents extends null {
  /**
   * @param {Array|number} intents - Array or bitfield of Intents to parse
   * @returns {Array|number} - Bitfield of parsed intents
   */
